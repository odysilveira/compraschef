...
export const seedDB: DB = {
  ...
  pessoas: [
    ...
    },
    {
      ...
      atualizado_em: diasAtras(1),
      observacao: "Regularizar contrato intermitente / CCT entregadores",
    },
  ],
  ...
  pagamentos_pessoas: [
    {
      ...
      pagamento_banco_conta: "PIX marcia",
    ...
    },
    {
      ...
      pagamento_banco_conta: "PIX carlos.extra@pix",
      pagamento_responsavel: "Ody",
