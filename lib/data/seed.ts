...
export const seedDB: DB = {
  ...
  pessoas: [
    ...
    },
    {
      ...
      funcao: "salao",
      cargo: "Prestador eventual (MEI)",
      telefone: "(43) 98888-5000",
      valor_hora: 25,
      chave_pix: "diego.eventual@pix",
      observacao:
        "MEI eventual — máx. 2 serviços/semana no ComprasChef; pagamento por hora com repasse integral (sem retenção neste módulo).",
  ...
  pagamentos_pessoas: [
    ...
    },
    {
      ...
      tipo: "freela_hora",
      descricao: "Serviço eventual — 4 h (repasse integral)",
      competencia: "2026-08",
      vencimento: soData(diasAFrente(2)),
      valor: 100,
      valor_bruto: 100,
      horas: 4,
      valor_hora: 25,
      status: "previsto",
      pagamento_observacao: "Sem retenção no ComprasChef — valor integral ao prestador.",
      criado_em: diasAtras(1),
      atualizado_em: diasAtras(1),
    },
  ],
